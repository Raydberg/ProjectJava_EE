...
<section class="d-flex justify-content-center align-items-center">
	...
	<legend>Crear</legend>
		...
		<div class="form-floating ">
		<input class="form-control " type="number" name="unidades" id="unidades"placeholder="unidades" >
	...
	<table id="productsTable" style="width: 100px; height: 250px;" border="1" class="table table-dark table-hover text-white">
		<thead>
			<tr>
				<th>Id</th>
				<th>Nombre</th>
